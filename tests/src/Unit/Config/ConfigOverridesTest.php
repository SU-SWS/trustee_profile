...
namespace Drupal\Tests\trustee_profile\Unit\Config;

use Drupal\Core\Cache\CacheableMetadata;
use Drupal\Core\Config\Config;
use Drupal\Core\Config\ConfigFactoryInterface;
use Drupal\Core\State\StateInterface;
use Drupal\trustee_profile\Config\ConfigOverrides;
...
class ConfigOverridesTest extends UnitTestCase {
  ...
  /**
   * @var \Drupal\trustee_profile\Config\ConfigOverrides
   */
  ...
  public function getStateCallback($name) {
    switch ($name) {
      case 'trustee_profile.403_page':
        return '/node/403';

      case 'trustee_profile.404_page':
        return '/node/404';

      case 'trustee_profile.front_page':
        return '/node/99';
